...
import { isValidNetwork, useNetworkConfiguration } from "./NetworkConfigurationProvider";
...
export function WalletContextProvider({ children }: { children: ReactNode }) {
  ...
  const endpoint = useMemo(() => {
    ...
    const defaultCluster: typeof networkConfiguration = isValidNetwork(envCluster)
      ? envCluster
      : "devnet";
